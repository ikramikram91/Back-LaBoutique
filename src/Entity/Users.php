...
class Users implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=CustomerAdress::class, mappedBy="user")
     */
    private $customerAdresses;
    ...
    /**
     * @return Collection|CustomerAdress[]
     */
    ...
    public function addCustomerAdress(CustomerAdress $customerAdress): self
    {
        if (!$this->customerAdresses->contains($customerAdress)) {
            $this->customerAdresses[] = $customerAdress;
    ...
    public function removeCustomerAdress(CustomerAdress $customerAdress): self
    {
